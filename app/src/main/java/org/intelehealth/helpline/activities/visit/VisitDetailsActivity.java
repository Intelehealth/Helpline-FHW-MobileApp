...
import static org.intelehealth.helpline.database.dao.EncounterDAO.getChiefComplaint;
import static org.intelehealth.helpline.database.dao.ObsDAO.fetchDrDetailsFromLocalDb;
import static org.intelehealth.helpline.database.dao.ObsDAO.getFollowupDataForVisitUUID;
import static org.intelehealth.helpline.database.dao.PatientsDAO.phoneNumber;
import static org.intelehealth.helpline.database.dao.VisitAttributeListDAO.fetchSpecialityValue;
import static org.intelehealth.helpline.database.dao.VisitsDAO.fetchVisitModifiedDateForPrescPending;
import static org.intelehealth.helpline.database.dao.VisitsDAO.isVisitNotEnded;
import static org.intelehealth.helpline.utilities.DateAndTimeUtils.timeAgoFormat;
...
import org.intelehealth.helpline.activities.visit.adapter.PastVisitListingAdapter;
import org.intelehealth.helpline.activities.visit.model.PastVisitData;
import org.intelehealth.helpline.activities.visitSummaryActivity.VisitSummaryActivity_New;
...
import org.intelehealth.helpline.utilities.VisitUtils;
        ...
        if (chief_complaint_value != null && !chief_complaint_value.isEmpty()) {
            ...
            if (needToShowCoreValue) {
                ...
                for (String s : spt) {
                    ...
                    if (!complainName.trim().contains(org.intelehealth.helpline.ayu.visit.common.VisitUtils.getTranslatedPatientDenies(sessionManager.getAppLanguage()))) {
                            ...
                            if (visitValue != null && !visitValue.isEmpty()) {
                                ...
                                if (needToShowCoreValue) {
                                    ...
                                    for (String s : spt) {
                                        ...
                                        System.out.println(s);
                                        //if (s.trim().startsWith(getTranslatedAssociatedSymptomQString(lCode))) {
                                        if (!s.trim().contains(org.intelehealth.helpline.ayu.visit.common.VisitUtils.getTranslatedPatientDenies(sessionManager.getAppLanguage()))) {
                                            list.add(s);
                                        }
