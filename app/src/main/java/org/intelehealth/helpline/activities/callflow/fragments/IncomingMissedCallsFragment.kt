...
class IncomingMissedCallsFragment : Fragment(R.layout.fragment_layout) {
    private val TAG = "IncomingMissedCallsFrag"
    ...
    companion object {
        fun newInstance(): IncomingMissedCallsFragment {
            return IncomingMissedCallsFragment()
        }
    }
