...
class MissedCallTypesActivity : BaseActivity(), NetworkUtils.InternetCheckUpdateInterface {
    ...
    private fun initUI() {
        ...
        ivIsInternet.setOnClickListener {
            SyncUtils.syncNow(this@MissedCallTypesActivity, ivIsInternet, syncAnimator)
        }

        ivBackArrow.setOnClickListener {
            val intent = Intent(this@MissedCallTypesActivity, HomeScreenActivity_New::class.java)
